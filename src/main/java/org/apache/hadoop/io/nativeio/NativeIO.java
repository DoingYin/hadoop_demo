    ...
    static {
        if (NativeCodeLoader.isNativeCodeLoaded()) {
            try {
                ...
                LOG.error("Unable to initialize NativeIO libraries", var1);
            }
        }
...
//            return access0(path, desiredAccess.accessRight());
        ...
        static {
            if (NativeCodeLoader.isNativeCodeLoaded()) {
                try {
                    ...
                    NativeIO.LOG.error("Unable to initialize NativeIO libraries", var1);
                }
            }
    ...
    public static class POSIX {
        ...
        static native void munlock_native(ByteBuffer var0, long var1) throws NativeIOException;
